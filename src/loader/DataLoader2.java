 ...
 */
public class DataLoader2 <T extends DataType, M extends DataContainer<T>> {

    public static final String ANSI_GREEN = "\u001B[32m";
    public static final String ANSI_RESET = "\u001B[0m";

    private final Supplier<M> myContainerSupplier;
    private final Class<T> myDataClass;

    public DataLoader2(Class<T> theDataClass, Supplier<M> theSupplier){
        super();
        myContainerSupplier = theSupplier;
        myDataClass = theDataClass;
        validateConstructor(theDataClass, theSupplier::get);
    }
     ...
     */
    public M loadData(String theFilePath)
            throws IllegalArgumentException, IOException{

        M dataContainer = myContainerSupplier.get();
