...
public abstract class HashTableBenchMark<T extends DataType, M extends HashableManager<T>> implements Experiment {
    ...
    private final ExperimentResults myResults = new ExperimentResults();
    private static final int TRIAL_RUNS = 30;


    public HashTableBenchMark(Class<T> theDataClass, MapManager<T> theManager, ExperimentFormat theExperimentFormat) {
        super();
    ...
    public void printResults() {
        myResultsDisplay.printResults(myResults.getResults());
    }
}
