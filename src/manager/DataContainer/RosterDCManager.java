 ...
 * @version 1.2
 */
final public class RosterDCManager
        extends DataContainerManager<Player, DataContainer<Player>> {

    public RosterDCManager(Supplier<DataContainer<Player>> theSupplier){
    ...
    @Override
    public Class<manager.RosterManager> getManagerClass(){
        return manager.RosterManager.class;
    }
