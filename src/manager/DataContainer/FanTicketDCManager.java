 ...
 * @version 1.1
 */
public class FanTicketDCManager
        extends DataContainerManager<FanRequest, DataContainer<FanRequest>> {

    private static final Logger LOGGER = Logger.getLogger(FanTicketDCManager.class.getName());

    public FanTicketDCManager(Supplier<DataContainer<FanRequest>> theSupplier) {
    ...
    @Override
    public Class<manager.FanTicketQueue> getManagerClass() {
        return manager.FanTicketQueue.class;
    }
