 ...
 * @version 1.2
 */
public class TransactionDCManager
        extends DataContainerManager<Transaction, DataContainer<Transaction>> {


    public TransactionDCManager(Supplier<DataContainer<Transaction>> theSupplier) {
    ...
    @Override
    public Class<manager.TransactionFeed> getManagerClass(){
        return manager.TransactionFeed.class;
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        manager.TransactionFeed feed = new manager.TransactionFeed(sup);
